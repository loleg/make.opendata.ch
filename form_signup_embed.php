...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/app/stylesheets/min.css" media="all" />
    <link rel="stylesheet" type="text/css" href="assets/app/stylesheets/signup.css" media="all" />
	...
	<link rel="stylesheet" type="text/css" href="assets/app/stylesheets/style.css" media="screen" />
...
<body style="border:none"><div id="content">
<?php
...
$trans['I have a comment'] = array('en'=>'I have a comment:', 'de'=>'Mein Kommentar:', 'fr'=>'Commentaires:');
...
<div class="form-entry">
    <label class="ss-q-title" for="entry_2"><?= $trans['First name'][$curLang] ?> <span class="ss-required-asterisk">*</span></label>
    <input type="text" name="entry.2.single" value="" id="entry_2" class="required"/>
</div>

<div class="form-entry">
    <label class="ss-q-title" for="entry_8"><?= $trans['Last name'][$curLang] ?> <span class="ss-required-asterisk">*</span></label>
    <input type="text" name="entry.8.single" value="" id="entry_8" class="required"/>
</div>

<div class="form-entry">
    <label class="ss-q-title" for="entry_3"><?= $trans['Email address'][$curLang] ?> <span class="ss-required-asterisk">*</span></label>
    <input type="text" name="entry.3.single" value="" id="entry_3" class="required email" />
</div>

<div class="form-entry">
    <label class="ss-q-title" for="entry_4"><?= $trans['I\'m coming to'][$curLang] ?></label>
...
<div class="form-entry">
    <label class="ss-q-title" for="entry_5"><?= $trans['I\'m coming on'][$curLang] ?></label>
...
<div class="form-entry ss-checkbox">
    <label class="ss-q-title" for="entry_6"><?= $trans['I\'m a...'][$curLang] ?></label>
    <ul class="form-choices">
        <li>
            <label class="ss-choice-label"><input type="checkbox" name="entry.6.group" value="Designer" id="group_6_1" /> <?= $trans['Designer'][$curLang] ?></label>
        </li>
        <li >
            <label class="ss-choice-label"><input type="checkbox" name="entry.6.group" value="Developer" id="group_6_2" /> <?= $trans['Developer'][$curLang] ?></label>
        </li>
        <li >
            <label class="ss-choice-label"><input type="checkbox" name="entry.6.group" value="Ideator" id="group_6_3" /> <?= $trans['Ideator'][$curLang] ?></label>
        </li>
        <li >
            <label class="ss-choice-label"><input type="checkbox" name="entry.6.group" value="Data provider or expert" id="group_6_4" /> <?= $trans['Data provider or expert'][$curLang] ?></label>
        </li>
    </ul>
</div>

<div class="errorbox-good ss-item ss-paragraph-text ss-form-entry">
    <label class="ss-q-title" for="entry_7"><?= $trans['I have a comment'][$curLang] ?></label>
    <textarea name="entry.7.single" rows="8" cols="75"  id="entry_7"></textarea>
</div>


<div class="ss-item ss-navigate">
    	<label class="ss-q-title" for="entry_8">&nbsp;</label>
    	<input id="entry_8" type="submit" name="submit" value="<?= $trans['Sign up now'][$curLang] ?>" />
</div>
...
$(function() {
    ...
    $('#hidden-iframe').load(function() {
        ...
        if(submitted) {
            window.parent.location = '/?page_id=222';
        }
    });
